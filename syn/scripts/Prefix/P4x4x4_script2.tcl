...
analyze -format verilog {../src/P64_adder.v}


set all_modules {P4x4x4_stage_1 P4x4x4_stage_2 P4x4x4_stage_3  } 
...
report_timing -significant 3 > P4x4x4_adder.log
report_area -hierarchy >> P4x4x4_adder.log

set_switching_activity -static 0.5 [all_inputs]

report_power >> P4x4x4_adder.log
