...
analyze -format verilog {../src/P8_adder.v}


set all_modules {P8_stage_1 P2x4_stage_2 } 
...
report_timing -significant 3 > P2x4_adder.log
report_area -hierarchy >> P2x4_adder.log

set_switching_activity -static 0.5 [all_inputs]

report_power >> P2x4_adder.log
