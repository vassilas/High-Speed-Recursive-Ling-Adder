...
set all_modules {P32_stage_1 P2x4x4_stage_2 P2x4x4_stage_3} 
...
report_timing -significant 3 > P2x4x4_adder.log
report_area -hierarchy >> P2x4x4_adder.log

#set_switching_activity -static 0.5 [all_inputs]

report_power >> P2x4x4_adder.log
