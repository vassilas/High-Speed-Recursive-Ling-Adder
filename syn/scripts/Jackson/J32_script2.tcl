...
analyze -format verilog {../src/J32_adder.v}


set all_modules {J32_stage_1 J32_stage_2 J32_stage_3} 
...
report_timing -significant 3 > J32_adder.log
report_area -hierarchy >> J32_adder.log

#set_switching_activity -static 0.5 [all_inputs]

report_power >> J32_adder.log
