...
analyze -format verilog {../src/J16_adder.v}


set all_modules {J4x4_stage_1 J4x4_stage_2 J4x4_D_recursion} 
...
report_timing -significant 3 > J4x4_adder.log
report_area -hierarchy >> J4x4_adder.log

set_switching_activity -static 0.5 [all_inputs]

report_power >> J4x4_adder.log
