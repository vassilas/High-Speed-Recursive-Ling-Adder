...
analyze -format verilog {../src/L16_adder.v}


set all_modules {L4x4_stage_1 L4x4_stage_2 } 
...
report_timing -significant 3 > L4x4_adder.log
report_area -hierarchy >> L4x4_adder.log

set_switching_activity -static 0.5 [all_inputs]

report_power >> L4x4_adder.log
