...
analyze -format verilog {../src/L8_adder.v}


set all_modules {L8_stage_1 L2x4_stage_2 } 
...
report_timing -significant 3 > L2x4_adder.log
report_area -hierarchy >> L2x4_adder.log

set_switching_activity -static 0.5 [all_inputs]

report_power >> L2x4_adder.log
